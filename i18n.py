...
messages = {
    ...
    "GS390XIONW0001L": _("Configured network I/O device '%(ident)s'"),
    "GS390XIONW0002L": _("Unconfigured network I/O device '%(ident)s'"),
    "GS390XIOST0001L": _("Brought storage I/O device '%(ident)s' online"),
    "GS390XIOST0002L": _("Brought storage I/O device '%(ident)s' offline"),
    "GS390XSTG0001L": _("Enabled LUN scan"),
    "GS390XSTG0002L": _("Disabled LUN scan"),
    "GS390XSTG0003L": _("Triggered LUN scan"),
    "GS390XSTG0004L": _("Added LUN '%(hbaId)s : %(remoteWwpn)s : %(lunId)s'"),
    "GS390XSTG0005L": _("Removed LUN '%(ident)s'"),
}
